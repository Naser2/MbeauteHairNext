...
const styles = {
  shapes: {
    roundedFull: [
      "rounded-full bg-indigo-600 px-2 sm:px-0.5 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
    roundedmd: [
      "rounded-md bg-indigo-600 px-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
    roundedLg: [
      "rounded-lg bg-indigo-600 px-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
    roundedLg: [
      "rounded-lg bg-indigo-600 px-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
    roundedXl: [
      "rounded-sm bg-indigo-600 px-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
    rounded2Xl: [
      "rounded-2xl bg-indigo-600 px-1 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
    ],
  },
  base: [
    // Base
 ...
 const Button = React.forwardRef(function Button({ color, outline, plain, shape, iconName, handlePress, className, children, ...props }, ref) {
  let classes = clsx(
    className,
    styles.base,    styles.shapes[shape],
  ...
  return 'href' in props ? (
    ...
    <button
        type="button"  onClick={()=>handlePress(handlePress)} {...props} className={clsx(classes, 'cursor-default yt-spec-button-shape rounded-full bg-indigo-600 py-3 px-4 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600')} ref={ref}>
        

    {/* {iconName && <Icon iconName={iconName} /> } */}
  <TouchTarget><Icon className="h-5 w-5 sm:h-6" aria-hidden="true" /></TouchTarget>  
  </button>
