...
const Cart =({addItemCount}) =>{
    return (
        ...
        className="menu-togglee hover:ring-1  rounded-full hover:ring-black h-8 w-8 mt-4  hover:bg-white"
        id="menu-togglee">
         <a className=" empty" href="/cart" title="Commander">
             <span class="header-link-icon pb-8 justify-center flex">
             {/* <CartSVG/> */}
          <svg width="26" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg" class="justify-center pt-2">
